...
class Sendit_Bliskapaczka_Model_Observer
{
    ...
    public static function load($class)
    {
        if (preg_match('#^(Bliskapaczka\\\\ApiClient)\b#', $class)) {
            $libDir = Mage::getBaseDir() . '/vendor/bliskapaczka/bliskapaczka-api-client/src/';
    ...
    public function createOrderViaApi(Varien_Event_Observer $observer)
    {
        ...
        $apiKey = Mage::getStoreConfig(Sendit_Bliskapaczka_Helper_Data::API_KEY_XML_PATH);

        /* @var Sendit_Bliskapaczka_Helper_Data $apiClient */
